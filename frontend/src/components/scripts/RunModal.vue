    ...
    <div class="w-full max-w-2xl max-h-[calc(100vh-32px)] bg-white dark:bg-[#111827] rounded-2xl shadow-2xl border border-slate-200 dark:border-[#1e293b] flex flex-col overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto p-5 flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-1.5">
              <button type="button" class="text-[10px] text-blue-500 hover:underline" @click="selectAllHosts">全选</button>
          ...
          <select
            ...
            multiple
            size="4"
            class="h-auto min-h-[72px] px-3 py-1.5 rounded-lg border border-slate-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#0b1324] text-xs text-slate-700 dark:text-slate-200 outline-none focus:border-blue-400"
          >
        ...
        <div v-if="(script.parameters || []).length > 0" class="flex flex-col gap-2">
          ...
          >
            ...
            <select
              ...
              class="h-8 px-3 rounded-lg border border-slate-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#0b1324] text-xs text-slate-700 dark:text-slate-200 outline-none focus:border-blue-400"
              @change="onParamInput"
            >
        ...
        <div class="flex flex-col gap-1">
          <div class="flex items-center justify-between">
            ...
            <button type="button" class="text-[10px] text-blue-500 hover:underline" @click="refreshPreview">🔄 刷新预览</button>
          </div>
      ...
      <div class="shrink-0 flex items-center justify-end gap-2 px-5 py-3 border-t border-slate-100 dark:border-[#1e293b] bg-slate-50/50 dark:bg-slate-800/30">
        ...
        <button
          type="button"
          :disabled="running"
          class="h-8 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-blue-500 text-white text-xs font-semibold shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
          @click="onExecute"
