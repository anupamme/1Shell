...
<template>
  <div class="flex-1 overflow-y-auto p-2 flex flex-col gap-2">
    ...
    <div
      ...
      :class="s.id === currentId ? 'active border-blue-300' : 'border-slate-200 dark:border-[#1e293b]'"
    ...
    >
      ...
      <div class="mt-1.5 flex items-center gap-1.5 text-[10px] text-slate-400 flex-wrap">
        ...
        <span v-else class="text-blue-500 dark:text-blue-300">{{ (s.parameters || []).length }} 参数</span>
        <span>·</span>
