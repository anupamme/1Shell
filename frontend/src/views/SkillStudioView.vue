        ...
        <div class="flex items-center gap-3 shrink-0">
          ...
          <div>
            <div class="text-base font-bold text-slate-700 dark:text-slate-200 flex items-center gap-1.5">
              IDE 工作台
              <span class="text-[9px] px-1.5 py-0.5 rounded bg-blue-100 text-blue-600 dark:bg-blue-500/20 dark:text-blue-300 font-semibold">IDE</span>
            </div>
      ...
      <div class="flex flex-1 gap-2 min-h-0">
        ...
        <main class="flex-1 min-w-0 flex flex-col gap-2 min-h-0">
          <ChatArea
            ...
            :tool-calls="r.currentToolCalls.value"
