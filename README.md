...
[![version](https://img.shields.io/badge/version-4.7.7-4f8cff?style=flat-square)](https://github.com/weidu12123/1Shell/releases)
...
| 脚本库 | 沉淀常用运维脚本，在终端里一键注入；1Shell AI 可读写和运行 |
