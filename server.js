...
const { createHostCapabilityRouter } = require('./src/routes/host-capability.routes');
...
const remoteMcpService = createRemoteMcpService({ dataDir, auditService, logger: log });
const hostCapabilityScanner = createHostCapabilityScanner({ dataDir, logger: log });
const hostCapabilityService = createHostCapabilityService({ dataDir, mcpRegistry, libraryService, nativeCliConfig, mcpPresetStore, hostCapabilityScanner, logger: log });
