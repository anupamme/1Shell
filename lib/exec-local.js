...
function execLocalCommand(command, { timeout = 30000, cwd, signal, maxBuffer = 8 * 1024 * 1024 } = {}) {
...
function spawnLocalScript(command, { timeout = 30000, signal, windowsShell = 'powershell', maxBuffer = 8 * 1024 * 1024 } = {}) {
